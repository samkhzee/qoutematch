...
class AutomaticGatewayController extends Controller
{
    public function index()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.gateways.automatic.list', compact('pageTitle', 'gateways'));
    }
    ...
    public function edit($alias)
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.gateways.automatic.edit', compact('pageTitle', 'gateway', 'supportedCurrencies', 'parameters', 'hasCurrencies', 'currencyIndex', 'globalParameters'));
    }
