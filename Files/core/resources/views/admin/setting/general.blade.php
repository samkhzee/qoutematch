                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-sm-6">
                                <div class="form-group ">
                                    <label>@lang('Fixed Trial Task Charge')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="fixed_trial_task_charge" step="any" required value="{{ getAmount(gs('fixed_trial_task_charge')) }}">
                                        <span class="input-group-text">{{ gs('cur_text') }}</span>
                                    </div>
                                </div>
                            </div>
