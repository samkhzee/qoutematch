...
export default function Login({ pageTitle, authContent, bannerContent, switchingButtons }) {
                    ...
                    <>
                        ...
                        <form onSubmit={submit} className="loginForm">
                            <div className="account-form">
                                <UserTypeSwitch current="freelancer" />
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <div className="form-group">
                                            ...
                                            <input type="text" name="username" id="username" className="form-control form--control"
