...
export default function CompleteProfile({ pageTitle, authContent, countries, suggestedUsername, defaultCountryCode, user }) {
    const { routes } = usePage().props;
    const defaultCountry = countries.find((c) => c.code === defaultCountryCode) || countries.find((c) => c.code === 'GB') || countries[0];

    const { data, setData, post, processing, errors } = useForm({
        username: user?.username || suggestedUsername || '',
                ...
                right={
                    <>
                        ...
                        <div className="account-form">
                            ...
                            <p className="mb-4">Add your location details to start receiving quote requests.</p>
