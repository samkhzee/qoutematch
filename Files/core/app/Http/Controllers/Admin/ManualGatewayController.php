...
class ManualGatewayController extends Controller
{
    public function index()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.gateways.manual.list', compact('pageTitle', 'gateways'));
    }

    public function create()
    {
        $pageTitle = 'Add Manual Gateway';
        return \App\Lib\InertiaBridge::admin('admin.gateways.manual.create', compact('pageTitle'));
    }
    ...
    public function edit($alias)
    {
        ...
        $form = $method->form;
        return \App\Lib\InertiaBridge::admin('admin.gateways.manual.edit', compact('pageTitle', 'method','form'));
    }
