...
class NotificationController extends Controller
{
    ...
    public function globalSms(){
        ...
        return \App\Lib\InertiaBridge::admin('admin.notification.global_sms_template', compact('pageTitle'));
    }
    ...
    public function globalPush(){
        ...
        return \App\Lib\InertiaBridge::admin('admin.notification.global_push_template', compact('pageTitle'));
    }
    ...
    public function templates(){
        ...
        return \App\Lib\InertiaBridge::admin('admin.notification.template.index', compact('pageTitle','templates'));
    }
    ...
    public function templateEdit($type,$id)
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.notification.template.'.$type, compact('pageTitle', 'template'));
    }
    ...
    public function emailSetting(){
        ...
        return \App\Lib\InertiaBridge::admin('admin.notification.email_setting', compact('pageTitle'));
    }
   ...
   public  function smsSetting(){
        ...
        return \App\Lib\InertiaBridge::admin('admin.notification.sms_setting', compact('pageTitle'));
    }
