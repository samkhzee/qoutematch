...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.dashboard', compact('pageTitle', 'widget', 'chart','deposit','withdrawals'));
    }
    ...
    public function profile()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.profile', compact('pageTitle', 'admin'));
    }
    ...
    public function password()
    {
        ...
        $admin = auth('admin')->user();
        return \App\Lib\InertiaBridge::admin('admin.password', compact('pageTitle', 'admin'));
    }
    ...
    public function notifications(){
        ...
        return \App\Lib\InertiaBridge::admin('admin.notifications', compact('pageTitle','notifications','hasUnread','hasNotification'));
    }
