                                ...
                                @forelse ($conversations as $conv)
                                    ...
                                    <li
                                        ...
                                        <div class="user__wrapper">
                                            <a href="{{ route('user.conversation.index', $conv->id) }}" class="user-link"></a>
                                            <span class="icon"> <img
                                            ...
                                            <div class="chat-item">
                                                ...
                                                @include('Template::partials.conversation_list_actions', [
                                                    'conv' => $conv,
                                                    'role' => 'freelancer',
                                                    'deleteRoute' => route('user.conversation.delete', $conv->id),
                                                ])
                                                <p
                                    ...
                                    <div class="chat-send-area">
                                        <div class="chat-send-field">
                                            <form class="send__msg" id="messageForm" method="POST"
                                                action="{{ ($id ?? 0) ? route('user.conversation.store', $id) : '#' }}"
                                                enctype="multipart/form-data"
                                                data-store-url="{{ ($id ?? 0) ? route('user.conversation.store', $id) : '' }}">
                                                @csrf
