        ...
        <div class="card-body">
            <div class="row gy-3 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <strong>{{ $dispute->user?->fullname ?? '—' }}</strong>
                </div>
                <div class="col-md-6">
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('buyer.disputes.index') }}" class="btn btn-outline--base btn-sm">@lang('All Disputes')</a>
                @if ($dispute->project_id)
                    <a href="{{ route('buyer.project.detail', $dispute->project_id) }}" class="btn btn--base btn-sm">
                        @lang('View Project')
                    </a>
                @endif
            </div>
