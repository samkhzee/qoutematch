...
class PageBuilderController extends Controller
{
    ...
    public function managePages()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.frontend.builder.pages', compact('pageTitle','pData'));
    }
    ...
    public function manageSection($id)
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.frontend.builder.index', compact('pageTitle','pData','sections'));
    }
    ...
    public function manageSeo($id){
        ...
        return \App\Lib\InertiaBridge::admin('admin.frontend.builder.seo', compact('pageTitle','page'));
    }
