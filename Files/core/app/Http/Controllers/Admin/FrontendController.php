...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.frontend.index', compact('pageTitle'));
    }
    ...
    public function templates()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.frontend.templates', compact('pageTitle', 'templates', 'extraTemplates'));
    }
    ...
    public function seoEdit()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.frontend.seo', compact('pageTitle', 'seo'));
    }
    ...
    public function frontendSections($key)
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.frontend.section', compact('section', 'content', 'elements', 'key', 'pageTitle'));
    }
    ...
    public function frontendElement($key, $id = null)
    {
        ...
        if ($id) {
            ...
            return \App\Lib\InertiaBridge::admin('admin.frontend.element', compact('section', 'key', 'pageTitle', 'data'));
        }
        return \App\Lib\InertiaBridge::admin('admin.frontend.element', compact('section', 'key', 'pageTitle'));
    }
    ...
    public function frontendSeo($key, $id)
    {
        ...
        $pageTitle = 'SEO Configuration';
        return \App\Lib\InertiaBridge::admin('admin.frontend.frontend_seo', compact('pageTitle', 'key', 'data'));
    }
