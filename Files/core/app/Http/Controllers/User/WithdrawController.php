...
class WithdrawController extends Controller
{
    ...
    public function withdrawMoney()
    {
        ...
        return Inertia::render('User/Withdraw/Methods', [
            'pageTitle' => $pageTitle,
            'methods' => AccountResource::withdrawMethods($withdrawMethod),
            'storeUrl' => route('user.withdraw.money'),
        ]);
    }
    ...
    public function withdrawPreview()
    {
        ...
        return Inertia::render('User/Withdraw/Preview', [
            'pageTitle' => $pageTitle,
            'preview' => AccountResource::withdrawPreview($withdraw, 'freelancer'),
        ]);
    }
    ...
    public function withdrawLog(Request $request)
    {
        ...
        return Inertia::render('User/Withdraw/History', [
            'pageTitle' => $pageTitle,
            'withdrawals' => AccountResource::withdrawals($withdraws),
            'indexUrl' => route('user.withdraw.history'),
        ]);
    }
}
