...
class WithdrawMethodController extends Controller
{
    public function methods()
    {
        ...
        return Inertia::render('Admin/WithdrawMethods/Index', [
            'pageTitle' => $pageTitle,
            'methods' => AdminResource::withdrawMethods($methods),
        ]);
    }
    ...
    public function create()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.withdraw.create', compact('pageTitle'));
    }
    ...
    public function edit($id)
    {
        ...
        $form = $method->form;
        return \App\Lib\InertiaBridge::admin('admin.withdraw.edit', compact('pageTitle', 'method','form'));
    }
