...
class LanguageController extends Controller
{
    ...
    public function langManage($lang = false)
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.language.lang', compact('pageTitle', 'languages'));
    }
    ...
    public function langEdit($id)
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.language.edit_lang', compact('pageTitle', 'json', 'lang', 'list_lang'));
    }
