...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'fixed_trial_task_charge' => 'required|numeric',
        ]);
        ...
        $general->fixed_trial_task_charge = $request->fixed_trial_task_charge;
        $general->save();
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->trial_task = $request->trial_task ? Status::ENABLE : Status::DISABLE;
        $general->save();
