                        ...
                        <div class="row justify-content-center gy-sm-4 gy-3">
                                ...
                                <div class="payment-system-list is-scrollable gateway-option-list">
                                    @foreach ($withdrawMethod as $data)
                                        <label for="{{ titleToKey($data->name) }}"
                                            ...
                                            <input class="payment-item__radio gateway-input" value="{{ $data->id }}"
                            ...
                            <div class="col-xl-6">
                                <div class="payment-system-list deposit-panel">
                                    ...
                                    <label class="deposit-panel__label" for="buyer-withdraw-amount-input">@lang('Amount')</label>
                                    <div class="deposit-amount-field">
                                        <span class="deposit-amount-field__prefix">{{ gs('cur_sym') }}</span>
                                        <input id="buyer-withdraw-amount-input"
