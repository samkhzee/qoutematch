...
class SubscriberController extends Controller
{
    public function index()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.subscriber.index', compact('pageTitle', 'subscribers'));
    }
    ...
    public function sendEmailForm()
    {
        ...
        return \App\Lib\InertiaBridge::admin('admin.subscriber.send_email', compact('pageTitle'));
    }
